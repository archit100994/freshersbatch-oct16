...
public class CRUD_Operations
{
	...
	public static void insertSQL(SessionFactory sessionFactory)
	{
		...
		//SQLQuery sqlQuery = session.createSQLQuery("INSERT INTO PRODUCT_MASTER(P_ID, NAME, COST) VALUES (555, 'PD', 150)");
	...
	public static void main(String[] args) throws Exception
	{
		...
		Product product = new Product("asdasd", 40000);
...
//		//OR
//		//Product product_2 = session_2.get(Product.class, productId);
