package springHibernate.Advertisement;
...
public class AdController
{
	...
	public Ad postAd(@RequestBody Ad ad, @RequestHeader String auth_token)
	{
		if(!auth_token.isEmpty())
		{
			Ad a1= ad;
			a1.setPostId("archit1");
			return AdService.create(a1);
		}
		return ad;
	}
*/	
	...
	public Ad postAdPut(@RequestBody Ad ad, @RequestHeader String auth_token)
	{
...
//			Ad a1= ad;
			//a1.setPostId("archit1");
			System.out.println("Count =========="+ad.getPhotocount());
